      ...
      <main ref={sectionRef} className="about">
        <section className="about__intro">
          <div className="about__intro-inner">
            ...
            <h1 className="reveal-on-scroll">Volcan Interactive Studios</h1>
        ...
        <section className="about__story">
          ...
          <div className="about__story-head">
            ...
            <h2 className="reveal-on-scroll">Pain Point</h2>
            <p className="reveal-on-scroll">
            ...
            <p className="about__founder reveal-on-scroll reveal-right">
              Busayo Ayodele
              <br />
          ...
          <div className="about__story-grid">
            <article>
              ...
              <h3 className="reveal-on-scroll reveal-left">Our Vision</h3>
            ...
            <article>
              ...
              <h3 className="reveal-on-scroll reveal-right reveal-slow">Our Mission</h3>
              <p className="reveal-on-scroll reveal-right reveal-slow">
        ...
        <section className="about__join">
          ...
          <h2 className="reveal-on-scroll">Join Us</h2>
          <p className="reveal-on-scroll">
          ...
          <button className="about__cta reveal-on-scroll" type="button">
            <span>Email Us</span>
          </button>
        </section>
      </main>
